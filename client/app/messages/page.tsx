...
export default function Messages() {
    ...
    const messages = [
        ...
        },
        {
            ...
            sender: "Kristin Watson",
            time: "7 minutes ago",
            text: "Anyway, let me know if you want to get involved. We could use your expertise.",
            avatar: "/api/placeholder/32/32",
            isOwn: false
        },
        {
        ...
        },
        {
            ...
            sender: "You",
            time: "",
            text: "Did you hear about the new project that's starting up? It's going to be a huge undertaking.",
            avatar: "/api/placeholder/32/32",
            isOwn: true
        },
        {
        ...
        },
        {
            ...
            sender: "Kristin Watson",
            time: "7 minutes ago",
            text: "http://designpop.com/Qz4EqSpc",
            avatar: "/api/placeholder/32/32",
            isOwn: false,
            hasFile: true,
            fileName: "Culture Handbook For Bengla",
            fileType: "Document.xpt"
        },
        {
            id: 8,
            sender: "Kristin Watson",
            time: "7 minutes ago",
            text: "That's a great suggestion",
            avatar: "/api/placeholder/32/32",
            isOwn: false
        },
        {
            ...
            sender: "Kristin Watson",
            time: "",
            text: "Yeah, I did. It looks like we have some areas where we can improve our sales numbers.",
            avatar: "/api/placeholder/32/32",
            isOwn: false
        },
        {
            ...
            sender: "You",
            time: "",
            text: "Anyway, let me know if you want to get involved. We could",
            avatar: "/api/placeholder/32/32",
            isOwn: true
        }
    ];
                    ...
                    <>
                        ...
                        <div className="flex-1 overflow-y-auto p-6">
                            ...
                            <div className="bg-white rounded-xl p-6 mb-6 shadow-sm">
                                <h2 className="text-lg font-semibold text-gray-900 mb-4">Time machine</h2>
